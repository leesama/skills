...
const DEFAULT_CONFIG_PATH = path_1.default.join(os_1.default.homedir(), ".config/weekly-report/config.json");
let AUTHOR = "";
let STAT_MODE = "week";
let WEEK_START = 0;
let WEEK_OFFSET = 0;
...
function loadConfig() {
    const candidates = [
        ...
        DEFAULT_CONFIG_PATH,
        path_1.default.join(os_1.default.homedir(), ".weekly-report.json"),
    ];
